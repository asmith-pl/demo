...
using PeakLogix.LogixPro.Auth.Api.Extensions;
using PeakLogix.LogixPro.Auth.Data;
using PeakLogix.LogixPro.Auth.Data.Context;
using PeakLogix.LogixPro.Auth.Data.Fido2;
using PeakLogix.LogixPro.Auth.Server;
using PeakLogix.LogixPro.Auth.Server.Fido2;
using PeakLogix.LogixPro.Auth.Server.Services;
using PeakLogix.LogixPro.Auth.Shared.Authorization;
...
builder.Services.AddDbContext<AuthDbContext>(options =>
{
    options.UseSqlServer(builder.Configuration.GetConnectionString("DefaultConnection"),
        b => b.MigrationsAssembly("PeakLogix.LogixPro.Auth.Data"));
